...
export const HeroSection = (props: Props) => {
  ...
  return (
    <div className="max-w-7xl w-full px-4 lg:px-20 pt-40 pb-10">
      <div className="flex justify-between gap-28 flex-col lg:flex-row">
        <div className="flex-1 flex flex-col gap-8">
          <h2 className="text-secondary-500 text-3xl/tight lg:text-6xl/tight font-medium pr-10">
          ...
          <div className="flex flex-col gap-2 py-2 ">
            <h3 className="text-lg text-slate-600 pl-1 text-center lg:text-start">
